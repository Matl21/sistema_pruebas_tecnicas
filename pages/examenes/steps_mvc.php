    ...
    <div class="tab-content">
                ...
                <tr>
                    <td>
                        <label>3.4 ¿Cuál es el resultado de coloca primero la creación de las tablas con la descripción
                            de los campos y luego la línea de código donde se crean la base de datos en un script de
                            T-SQL?</label>
                    </td>
                    <td>
        ...
        <div class="tab-pane container" id="etapa4">
            <table class="table-responsive table-bordered table-striped">
                ...
                <tr>
                    <td>
                        <label>4.4 ¿Qué pasaría si instanciamos un objeto a partir de una clase en la cual las
        ...
        <div class="tab-pane container" id="etapa5">
            <table class="table-responsive table-bordered table-striped">
                ...
                <tr>
                    <td>
                        <label>5.4 ¿Justifique para qué se realiza la documentación del código y cuáles son los tipos de
